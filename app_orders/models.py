...
class Order(models.Model):
    ...
    delivery_price = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="Цена доставки", default=0
    )
    payment_type = models.CharField(
        max_length=30, choices=PAYMENT_CHOICES, verbose_name="Тип оплаты", default="1"
    )
    ...
    status = models.CharField(
        max_length=150, verbose_name="статус платежа", blank=True, null=True
    )
